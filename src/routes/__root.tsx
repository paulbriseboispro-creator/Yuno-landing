...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Yuno — The operating system for the after-dark economy" },
      {
        property: "og:description",
        content:
          "All-in-one platform for clubs, organizers and promoters. VIP floor plans, click-and-collect bar, automated revenue splits.",
      },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Yuno — The operating system for the after-dark economy" },
      {
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Yuno",
          description:
            "Operating system for the after-dark economy: nightclub operations, ticketing and promoter payouts.",
        }),
      },
    ],
  }),
