...
const shotgunFr: ComparePageContent = {
  ...
  tldr: {
    title: "En bref",
    items: [
      "Commission organisateur : 0 % chez Yuno ; chez Shotgun, elle est fixée par contrat et n'est pas publiée.",
  ...
  table: {
    ...
    rows: [
      ...
      },
      {
        ...
        other: "Fixée par contrat avec Shotgun, non publiée.",
        verdict: "yuno",
      },
      {
      ...
      },
      {
        ...
        yuno: "Un seul scanner pour billets, guest list et tables ; recherche par nom ; staff connecté par code PIN.",
        other:
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Selon le centre d'aide de Shotgun, l'acheteur paie des frais de service de 2,75 % du montant de la transaction, avec un minimum de 0,30 €. La commission prélevée à l'organisateur est fixée par contrat avec Shotgun et n'est pas publiée. Chez Yuno, la commission organisateur est de 0 % et l'acheteur paie 4 % (minimum 0,99 €).",
      },
      {
...
const shotgunEn: ComparePageContent = {
  ...
  tldr: {
    title: "In short",
    items: [
      "Organizer commission: 0% with Yuno; with Shotgun it is set by contract and not published.",
  ...
  table: {
    ...
    rows: [
      ...
      },
      {
        ...
        other: "Set by contract with Shotgun, not published.",
        verdict: "yuno",
      },
      {
      ...
      {
        criterion: "Door",
        yuno: "One scanner for tickets, guest list and tables; name search; staff PIN login.",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "According to Shotgun's help centre, buyers pay a service fee of 2.75% of the transaction, with a €0.30 minimum. The commission charged to organizers is set by contract with Shotgun and is not published. With Yuno, the organizer commission is 0% and buyers pay 4% (€0.99 minimum).",
      },
      {
