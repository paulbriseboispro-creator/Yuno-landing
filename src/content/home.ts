...
const en = {
  ...
  comparison: {
    ...
    footerYuno: "A full year of Yuno costs €0 during launch — you only pay Stripe processing.",
  },
  differentiators: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "No sales call. No annual contract. No \"contact us for pricing.\" During launch, Yuno is free for clubs — every feature included. You decide.",
  ...
  savings: {
    eyebrow: "0% commission · free during launch",
    titleA: "Stop paying",
    titleEm: "10–15%",
    titleB: "on every ticket",
    body: "Shotgun, Weezevent and Xceed take a cut on every ticket you sell. Yuno takes 0% commission — and during launch, the software itself is free. See how much you'd save in a year.",
  },
  pricingTeaser: {
    eyebrow: "Pricing",
    title: "Ready to scale your nights?",
    sub: "Free for clubs during launch — every feature included, no subscription.",
  ...
  founding: {
    eyebrow: "Launch period",
    title: "Free for every club during launch",
    bodyA: "We're opening Yuno with the simplest deal possible: ",
    bodyVenues: "every feature, €0",
    bodyB: ". That means ",
    bodyMonths: "no subscription, no credit card, no commitment",
    bodyC: " — for the whole launch period. Yuno earns through ",
    bodyAnnual: "small service fees paid by your customers at checkout",
    bodyD: ". You only ever pay Stripe's processing fee.",
    bullets: [
...
const fr: HomeContent = {
  ...
  comparison: {
    ...
    footerYuno: "Une année complète de Yuno coûte 0 € pendant le lancement — vous ne payez que les frais Stripe.",
  },
  differentiators: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Pas d'appel commercial. Pas de contrat annuel. Pas de « contactez-nous pour un devis ». Pendant le lancement, Yuno est gratuit pour les clubs — toutes les fonctionnalités incluses. Vous décidez.",
  ...
  savings: {
    eyebrow: "0 % de commission · gratuit pendant le lancement",
    titleA: "Arrêtez de payer",
    titleEm: "10–15 %",
    titleB: "sur chaque billet",
    body: "Shotgun, Weezevent et Xceed prennent une part sur chaque billet que vous vendez. Yuno ne prend aucune commission — et pendant le lancement, le logiciel lui-même est gratuit. Découvrez combien vous économiseriez en un an.",
  },
  pricingTeaser: {
    eyebrow: "Tarifs",
    title: "Prêt à faire grandir vos soirées ?",
    sub: "Gratuit pour les clubs pendant le lancement — toutes les fonctionnalités incluses, sans abonnement.",
  ...
  founding: {
    eyebrow: "Période de lancement",
    title: "Gratuit pour chaque club pendant le lancement",
    bodyA: "Yuno s'ouvre avec l'offre la plus simple possible : ",
    bodyVenues: "toutes les fonctionnalités, 0 €",
    bodyB: ". Concrètement : ",
    bodyMonths: "sans abonnement, sans carte bancaire, sans engagement",
    bodyC: " — pendant toute la période de lancement. Yuno se rémunère via ",
    bodyAnnual: "de petits frais de service payés par vos clients au moment du paiement",
    bodyD: ". Vous ne payez que les frais de traitement Stripe.",
    bullets: [
