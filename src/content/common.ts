    ...
    index: [
      {
        ...
        category: "Product",
        to: "/clubs",
        keywords: ["vip", "floor", "tables", "minimum spend"],
      },
      {
        title: "Click & Collect bar",
        category: "Product",
        to: "/clubs",
        keywords: ["bar", "queue", "drinks", "order"],
      },
      {
        title: "Live Night dashboard",
        category: "Product",
        to: "/clubs",
        keywords: ["live", "dashboard", "entries", "revenue"],
      },
      {
        title: "PIN-based staff login",
        category: "Product",
        to: "/clubs",
        keywords: ["staff", "pin", "login", "bouncer"],
      },
      {
        title: "CRM & SMS marketing",
        category: "Product",
        to: "/clubs",
        keywords: ["crm", "sms", "marketing", "campaign"],
      },
      {
        title: "Ticketing & Stripe Connect splits",
        category: "Product",
        to: "/organizers",
        keywords: ["tickets", "stripe", "split", "payout"],
      },
      {
        title: "Promoter attribution & leaderboard",
        category: "Product",
        to: "/affiliates",
        keywords: ["promoter", "affiliate", "attribution", "commission"],
      },
      {
        title: "Pricing — Core, Essential, Pro, Elite",
        category: "Pricing",
        to: "/pricing",
        keywords: ["pricing", "plans", "cost", "free", "elite"],
      },
      {
        title: "For nightclubs",
        category: "Audience",
        to: "/clubs",
        keywords: ["club", "venue", "owner"],
      },
      {
        title: "For organizers",
        category: "Audience",
        to: "/organizers",
        keywords: ["organizer", "events"],
      },
      {
        title: "For promoters & agencies",
        category: "Audience",
        to: "/affiliates",
        keywords: ["promoter", "agency", "affiliate"],
      },
      {
        title: "How does the revenue split work?",
        category: "FAQ",
        to: "/#faq",
        keywords: ["revenue", "split", "stripe", "venue", "share"],
      },
      {
        title: "Which markets do you operate in?",
        category: "FAQ",
        to: "/#faq",
        keywords: ["markets", "country", "europe", "france", "spain"],
      },
      {
        title: "Book a demo",
        category: "Company",
        to: "/contact",
        keywords: ["demo", "contact", "sales", "call"],
      },
    ] as SearchEntry[],
  },
    ...
    index: [
      {
        ...
        category: "Product",
        to: "/clubs",
        keywords: ["vip", "salle", "tables", "minimum"],
      },
      {
        title: "Bar Click & Collect",
        category: "Product",
        to: "/clubs",
        keywords: ["bar", "file", "boissons", "commande"],
      },
      {
        title: "Tableau de bord Live Night",
        category: "Product",
        to: "/clubs",
        keywords: ["live", "tableau", "entrées", "revenus"],
      },
      {
        title: "Connexion du staff par code PIN",
        category: "Product",
        to: "/clubs",
        keywords: ["staff", "pin", "connexion", "videur"],
      },
      {
        title: "CRM & marketing SMS",
        category: "Product",
        to: "/clubs",
        keywords: ["crm", "sms", "marketing", "campagne"],
      },
      {
        title: "Billetterie & répartition Stripe Connect",
        category: "Product",
        to: "/organizers",
        keywords: ["billets", "stripe", "répartition", "versement"],
      },
      {
        title: "Attribution promoteurs & classement",
        category: "Product",
        to: "/affiliates",
        keywords: ["promoteur", "affilié", "attribution", "commission"],
      },
      {
        title: "Tarifs — Core, Essential, Pro, Elite",
        category: "Pricing",
        to: "/pricing",
        keywords: ["tarifs", "plans", "coût", "gratuit", "elite"],
      },
      {
        title: "Pour les clubs",
        category: "Audience",
        to: "/clubs",
        keywords: ["club", "établissement", "gérant"],
      },
      {
        title: "Pour les organisateurs",
        category: "Audience",
        to: "/organizers",
        keywords: ["organisateur", "événements"],
      },
      {
        title: "Pour les promoteurs & agences",
        category: "Audience",
        to: "/affiliates",
        keywords: ["promoteur", "agence", "affilié"],
      },
      {
        title: "Comment fonctionne la répartition des revenus ?",
        category: "FAQ",
        to: "/#faq",
        keywords: ["revenus", "répartition", "stripe", "club", "part"],
      },
      {
        title: "Dans quels marchés opérez-vous ?",
        category: "FAQ",
        to: "/#faq",
        keywords: ["marchés", "pays", "europe", "france", "espagne"],
      },
      {
        title: "Réserver une démo",
        category: "Company",
        to: "/contact",
        keywords: ["démo", "contact", "commercial", "appel"],
      },
    ],
  },
  rdv: {
    ...
    whatsappNumber: "33644216689",
    whatsappMessage:
      "Bonjour Yuno 👋 Je gère un établissement / des soirées et j'aimerais voir une démo.",
