...
const en = {
  ...
  compare: {
    ...
    footnote:
      "Based on each platform's public pages and help centers (Shotgun, Weezevent, Xceed, Fourvenues), checked between June and September 2026. Shotgun takes a 10% base commission on the organizer's sales, negotiated contract by contract; Fourvenues doesn't publish its pricing.",
  },
  email: {
...
const fr: LandingContent = {
  ...
  compare: {
    ...
    footnote:
      "D'après les pages publiques et centres d'aide de chaque plateforme (Shotgun, Weezevent, Xceed, Fourvenues), relevés entre juin et septembre 2026. Shotgun prend 10 % de commission de base sur les ventes de l'organisateur, négociée contrat par contrat ; Fourvenues ne publie pas ses tarifs.",
  },
  email: {
    eyebrow: "CRM & emailing",
...
const es: LandingContent = {
  ...
  compare: {
    ...
    footnote:
      "Según las páginas públicas y centros de ayuda de cada plataforma (Shotgun, Weezevent, Xceed, Fourvenues), consultados entre junio y septiembre de 2026. Shotgun cobra un 10 % de comisión base sobre las ventas del organizador, negociada contrato a contrato; Fourvenues no publica sus precios.",
  },
  email: {
