...
const en = {
  ...
  compare: {
    ...
    rows: [
      ...
      {
        name: "Shotgun",
        pays: "10% commission on your sales by default, negotiable by contract. Plus buyer fees, capped at €15.",
        keeps: "The marketplace.",
        you: false,
      },
    ],
    ...
    footnote:
      "Public prices checked on 21 September 2026 (publishers' pricing pages, Eventbrite help, Shotgun T&Cs). Shotgun takes a 10% base commission on the organizer's sales, negotiated contract by contract.",
  },
  email: {
...
const fr: LandingContent = {
  ...
  compare: {
    ...
    rows: [
      ...
      {
        name: "Shotgun",
        pays: "10 % de commission sur vos ventes de base, contrats négociables. Plus des frais acheteur plafonnés à 15 €.",
        keeps: "La marketplace.",
        you: false,
      },
    ],
    ...
    footnote:
      "Tarifs publics relevés le 21 septembre 2026 (pages Tarifs des éditeurs, aide Eventbrite France, CGU Shotgun). Shotgun prend de base 10 % de commission sur les ventes de l'organisateur, négociés contrat par contrat.",
  },
  email: {
    eyebrow: "CRM & emailing",
...
const es: LandingContent = {
  ...
  compare: {
    ...
    rows: [
      ...
      {
        name: "Shotgun",
        pays: "10 % de comisión sobre tus ventas de base, contratos negociables. Más gastos al comprador con tope de 15 €.",
        keeps: "El marketplace.",
        you: false,
      },
    ],
    ...
    footnote:
      "Precios públicos consultados el 21 de septiembre de 2026 (páginas de precios de cada plataforma, ayuda de Eventbrite, condiciones de Shotgun). Shotgun cobra de base un 10 % de comisión sobre las ventas del organizador, negociado contrato a contrato.",
  },
  email: {
