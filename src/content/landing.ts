...
const en = {
  ...
  hero: {
    ...
    notifications: [
      ...
      { icon: "ticket", title: "1,240 tickets sold tonight", meta: "Early Bird sold out · 21:04" },
      {
        icon: "crm",
        title: "+860 customers in your base",
        meta: "Added with every sale · this week",
      },
      {
        icon: "guests",
        title: "Guest list: 412 sign-ups",
        meta: "Free before 1 am · 96 via Inès's link",
      },
      { icon: "scan", title: "Lucas M. checked in", meta: "Guest list · via Inès's link" },
      {
        icon: "segment",
        title: "Segment “Table regulars”: 1,380",
        meta: "Seen < 60 days · avg. basket €142",
      },
      { icon: "mail", title: "Campaign: 318 sales", meta: "€7,420 net revenue attributed" },
      {
        icon: "wallet",
        title: "Night statement approved",
        meta: "Each side paid to its own account",
      },
    ],
  },
  clients: {
...
const fr: LandingContent = {
  ...
  hero: {
    ...
    notifications: [
      ...
      { icon: "ticket", title: "1 240 billets vendus ce soir", meta: "Early Bird complet · 21:04" },
      {
        icon: "crm",
        title: "+860 clients dans votre base",
        meta: "Ajoutés à chaque vente · cette semaine",
      },
      {
        icon: "guests",
        title: "Guest list : 412 inscrits",
        meta: "Gratuit avant 1 h · 96 via le lien d'Inès",
      },
      { icon: "scan", title: "Lucas M. est entré", meta: "Guest list · via le lien d'Inès" },
      {
        icon: "segment",
        title: "Segment « Habitués » : 1 380",
        meta: "Vus < 60 jours · panier moyen 142 €",
      },
      { icon: "mail", title: "Campagne : 318 ventes", meta: "7 420 € de CA net attribué" },
      {
        icon: "wallet",
        title: "Décompte de soirée validé",
        meta: "Chacun payé sur son propre compte",
      },
    ],
  },
  clients: {
...
const es: LandingContent = {
  ...
  hero: {
    ...
    notifications: [
      ...
      { icon: "ticket", title: "1.240 entradas vendidas hoy", meta: "Early Bird agotada · 21:04" },
      {
        icon: "crm",
        title: "+860 clientes en tu base",
        meta: "Añadidos con cada venta · esta semana",
      },
      {
        icon: "guests",
        title: "Lista: 412 inscritos",
        meta: "Gratis antes de la 1 h · 96 vía Inés",
      },
      {
        icon: "scan",
      ...
      {
        icon: "segment",
        title: "Segmento «Habituales»: 1.380",
        meta: "Vistos < 60 días · gasto medio 142 €",
      },
      { icon: "mail", title: "Campaña: 318 ventas", meta: "7.420 € de ingresos netos atribuidos" },
      {
        icon: "wallet",
        title: "Cierre de noche aprobado",
        meta: "Cada uno cobra en su propia cuenta",
      },
    ],
  },
  clients: {
